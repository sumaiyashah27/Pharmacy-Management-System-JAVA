...
import java.awt.Toolkit;
	...
	public class DelCashier extends JFrame {
		...
		public DelCashier() {
			...
			JLabel lblMngrId = new JLabel("Cashier ID :");
			...
			btnDeldb.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						String query="delete from cashier where c_id='"+textMngrId.getText()+"' ";
			...
			JLabel lbldelstr = new JLabel("Delete Cashier");
