...
import java.awt.Toolkit;
	...
	public class DelPharmacist extends JFrame {
		...
		public static void main(String[] args) {
			EventQueue.invokeLater(new Runnable() {
				public void run() {
					try {
						DelPharmacist dp = new DelPharmacist();
						dp.setVisible(true);
					} catch (Exception e) {
						e.printStackTrace();
					}
		...
		public DelPharmacist() {
			...
			JLabel lblMngrId = new JLabel("Pharmacist ID :");
			...
			btnDeldb.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						String query="delete from pharmacist where ph_id='"+textMngrId.getText()+"' ";
			...
			JLabel lbldelstr = new JLabel("Delete Pharmacist");
