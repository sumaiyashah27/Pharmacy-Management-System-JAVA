...
import javax.swing.SwingConstants;
	...
	public class MangCashier extends JPanel {
		...
		public MangCashier() {
			...
			JLabel lblManagePharmacist = new JLabel("Manage Cashier");
			...
			lblManagePharmacist.setBounds(429, 24, 405, 47);
			...
			scrollPanepharm.setBounds(95, 93, 1005, 382);
			add(scrollPanepharm);
