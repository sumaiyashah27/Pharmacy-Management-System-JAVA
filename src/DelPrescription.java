...
import java.awt.Toolkit;
	...
	public class DelPrescription extends JFrame {
		...
		public DelPrescription() {
			...
			JLabel lblMedId = new JLabel("Prescription ID :");
			...
			btnDeldb.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						String query="delete from prescription where p_id='"+textMedId.getText()+"' ";
			...
			JLabel lblRgstr = new JLabel("Delete Prescription");
