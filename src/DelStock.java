...
import java.awt.Toolkit;
	...
	public class DelStock extends JFrame {
		...
		public DelStock() {
			...
			panel.setBounds(162, 128, 871, 506);
			getContentPane().add(panel);
			panel.setLayout(null);
			
			JLabel lblMngrId = new JLabel("Stock ID :");
			...
			btnDeldb.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						String query="delete from medStock where st_id='"+textMngrId.getText()+"' ";
						
						stmt.executeUpdate(query);
						
							JOptionPane.showMessageDialog(null,"Stock Record Deleted");
						con.close();
						clearFields();
			...
			JLabel lbldelstr = new JLabel("Delete Stock");
			...
			lbldelstr.setBounds(242, 10, 461, 98);
			panel.add(lbldelstr);
			...
			btnSearch.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					try {
						...
						pst=con.prepareStatement("select * from medStock where st_id=?");
						...
						pst.setInt(1, Id);
						 ...
						 if(rs.next()) {
							 JOptionPane.showMessageDialog(null,"Stock Record Found");
						 }
						 else {
							 JOptionPane.showMessageDialog(null,"Stock Record Not Found");
							 textMngrId.setText("");
						 }
